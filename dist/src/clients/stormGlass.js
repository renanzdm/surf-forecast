...
exports.StormGlass = exports.StormGlassResponseError = exports.ClientRequestError = exports.StormGlassUnexpectedResponseError = void 0;
...
class StormGlassUnexpectedResponseError extends internal_error_1.InternalError {
    constructor(message) {
        super(message);
    }
}
exports.StormGlassUnexpectedResponseError = StormGlassUnexpectedResponseError;
...
class StormGlass {
    ...
    async fetchPoints(lat, lng) {
        const endTimeStamp = time_1.TimeUtil.getUnixTimeForAFutureDay(1);
        try {
            const response = await this.request.get(`${stormglassResourceConfig.get('apiUrl')}/weather/point?lat=${lat}&lng=${lng}&params=${this.stormGlassAPIParams}&source=${this.stormGlassAPISource}&=${endTimeStamp}`, {
                headers: {
