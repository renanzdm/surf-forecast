...
const api_forecast_response_one_beach_json_1 = __importDefault(require("@test/fixtures/api_forecast_response_one_beach.json"));
...
describe('Beach forecast functional tests', () => {
    ...
    it('should return a forecast with just a few times', async () => {
        ...
        expect(body).toEqual(api_forecast_response_one_beach_json_1.default);
    });
